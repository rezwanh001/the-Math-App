...
public class Level2Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myButton1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                if (myInput1.getText().toString().equals("6")) {
        ...
        myButton2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                if(myInput2.getText().toString().equals("5")) {
        ...
        myButton3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                if(myInput3.getText().toString().equals("26")) {
                ...
                if(clickCount[3] == 3){
                    Toast.makeText(getApplicationContext(), "Answer is: 26", Toast.LENGTH_LONG).show();
                    clickCount[3] = 0;
                    flag[3] = 1;
        ...
        myButton4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                if(myInput4.getText().toString().equals("97")) {
                ...
                if(clickCount[4] == 4){
                    Toast.makeText(getApplicationContext(), "Answer is: 97", Toast.LENGTH_LONG).show();
                    clickCount[4] = 0;
                    flag[4] = 1;
                }
        ...
        myButton5.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                if(myInput5.getText().toString().equals("6")) {
        ...
        myButton6.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                if(myInput6.getText().toString().equals("2")) {
        ...
        myButton7.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                if(myInput7.getText().toString().equals("27")) {
                ...
                if(clickCount[7] == 3){
                    Toast.makeText(getApplicationContext(), "Answer is: 27", Toast.LENGTH_LONG).show();
                    clickCount[7] = 0;
                    flag[7] = 1;
                }
        ...
        myButton8.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                if(myInput8.getText().toString().equals("Friday") || myInput8.getText().toString().equals("friday")) {
                ...
                if(clickCount[8] == 3){
                    Toast.makeText(getApplicationContext(), "Answer is: Friday or friday", Toast.LENGTH_LONG).show();
                    clickCount[8] = 0;
                    flag[8] = 1;
                }
        ...
        myButton9.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                if(myInput9.getText().toString().equals("60")) {
                ...
                if(clickCount[9] == 3){
                    Toast.makeText(getApplicationContext(), "Answer is: 60", Toast.LENGTH_LONG).show();
                    clickCount[9] = 0;
                    flag[9] = 1;
                }
        ...
        myButton10.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                if(myInput10.getText().toString().equals("1")) {
        ...
        myButton11.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                if(myInput11.getText().toString().equals("18000")) {
                ...
                if(clickCount[11] == 3){
                    Toast.makeText(getApplicationContext(), "Answer is: 18000", Toast.LENGTH_LONG).show();
                    clickCount[11] = 0;
                    flag[11] = 1;
                }
        ...
        myButton12.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                if(myInput12.getText().toString().equals("24")) {
                ...
                if(clickCount[12] == 3){
                    Toast.makeText(getApplicationContext(), "Answer is: 24", Toast.LENGTH_LONG).show();
                    clickCount[12] = 0;
                    flag[12] = 1;
                }
        ...
        myButton13.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                if(myInput13.getText().toString().equals("14")) {
                ...
                if(clickCount[13] == 3){
                    Toast.makeText(getApplicationContext(), "Answer is: 14", Toast.LENGTH_LONG).show();
                    clickCount[13] = 0;
                    flag[13] = 1;
                }
        ...
        myButton14.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                if(myInput14.getText().toString().equals("50")) {
                ...
                if(clickCount[14] == 3){
                    Toast.makeText(getApplicationContext(), "Answer is: 50", Toast.LENGTH_LONG).show();
                    clickCount[14] = 0;
                    flag[14] = 1;
                }
        ...
        myButton15.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                if(myInput15.getText().toString().equals("5")) {
    ...
    public void newbie(int marks){
        AlertDialog.Builder myAlert = new AlertDialog.Builder(this);
        myAlert.setMessage("You are Newbie in Level-2" + " & Scores : " + marks)
    ...
    public void pupil(int marks){
        AlertDialog.Builder myAlert = new AlertDialog.Builder(this);
        myAlert.setMessage("You are Pupil in Level-2" + " & Scores : " + marks)
                .setPositiveButton("Exit", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialogInterface, int i) {
                        dialogInterface.dismiss();
    ...
    public void specialist(int marks){
        AlertDialog.Builder myAlert = new AlertDialog.Builder(this);
        myAlert.setMessage("You are Specialist in Level-2" + " & Scores : " + marks)
                .setPositiveButton("Exit", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialogInterface, int i) {
                        dialogInterface.dismiss();
    ...
    public void expert(int marks){
        AlertDialog.Builder myAlert = new AlertDialog.Builder(this);
        myAlert.setMessage("You are Expert in Level-2" + " & Scores : " + marks)
                .setPositiveButton("Exit", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialogInterface, int i) {
                        dialogInterface.dismiss();
    ...
    public void master(int marks){
        AlertDialog.Builder myAlert = new AlertDialog.Builder(this);
        myAlert.setMessage("You are Master in Level-2" + " & Scores : " + marks)
                .setPositiveButton("Exit", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialogInterface, int i) {
                        dialogInterface.dismiss();
    ...
    public void grandmaster(int marks){
        AlertDialog.Builder myAlert = new AlertDialog.Builder(this);
        myAlert.setMessage("You are Grandmaster in Level-2" + " & Scores : " + marks)
                .setPositiveButton("Exit", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialogInterface, int i) {
                        dialogInterface.dismiss();
