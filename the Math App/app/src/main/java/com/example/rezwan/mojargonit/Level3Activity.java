...
public class Level3Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myButton1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                if (myInput1.getText().toString().equals("8")) {
                ...
                if(clickCount[1] == 3){
                    Toast.makeText(getApplicationContext(), "Answer is: 8", Toast.LENGTH_LONG).show();
                    clickCount[1] = 0;
                    flag[1] = 1;
                }
            }
        ...
        myButton2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                if(myInput2.getText().toString().equals("1")) {
        ...
        myButton3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                if(myInput3.getText().toString().equals("0")) {
                ...
                if(clickCount[3] == 3){
                    Toast.makeText(getApplicationContext(), "Answer is: 0", Toast.LENGTH_LONG).show();
                    clickCount[3] = 0;
                    flag[3] = 1;
                }
        ...
        myButton4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                if(myInput4.getText().toString().equals("10")) {
                ...
                if(clickCount[4] == 4){
                    Toast.makeText(getApplicationContext(), "Answer is: 10", Toast.LENGTH_LONG).show();
                    clickCount[4] = 0;
                    flag[4] = 1;
                }
        ...
        myButton5.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                if(myInput5.getText().toString().equals("1")) {
        ...
        myButton6.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                if(myInput6.getText().toString().equals("77")) {
                ...
                if(clickCount[6] == 3){
                    Toast.makeText(getApplicationContext(), "Answer is: 77", Toast.LENGTH_LONG).show();
                    clickCount[6] = 0;
                    flag[6] = 1;
                }
        ...
        myButton7.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                if(myInput7.getText().toString().equals("156")) {
                ...
                if(clickCount[7] == 3){
                    Toast.makeText(getApplicationContext(), "Answer is: 156", Toast.LENGTH_LONG).show();
                    clickCount[7] = 0;
                    flag[7] = 1;
                }
        ...
        myButton8.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                if(myInput8.getText().toString().equals("44")) {
                ...
                if(clickCount[8] == 3){
                    Toast.makeText(getApplicationContext(), "Answer is: 44", Toast.LENGTH_LONG).show();
                    clickCount[8] = 0;
                    flag[8] = 1;
                }
        ...
        myButton9.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                if(myInput9.getText().toString().equals("80")) {
                ...
                if(clickCount[9] == 3){
                    Toast.makeText(getApplicationContext(), "Answer is: 80", Toast.LENGTH_LONG).show();
                    clickCount[9] = 0;
                    flag[9] = 1;
                }
        ...
        myButton10.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                if(myInput10.getText().toString().equals("3")) {
        ...
        myButton11.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                if(myInput11.getText().toString().equals("64")) {
                ...
                if(clickCount[11] == 3){
                    Toast.makeText(getApplicationContext(), "Answer is: 64", Toast.LENGTH_LONG).show();
                    clickCount[11] = 0;
                    flag[11] = 1;
                }
        ...
        myButton12.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                if(myInput12.getText().toString().equals("3")) {
        ...
        myButton13.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                if(myInput13.getText().toString().equals("110")) {
                ...
                if(clickCount[13] == 3){
                    Toast.makeText(getApplicationContext(), "Answer is: 110", Toast.LENGTH_LONG).show();
                    clickCount[13] = 0;
                    flag[13] = 1;
                }
        ...
        myButton14.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                if(myInput14.getText().toString().equals("53")) {
        ...
        myButton15.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                if(myInput15.getText().toString().equals("10")) {
    ...
    public void newbie(int marks){
        AlertDialog.Builder myAlert = new AlertDialog.Builder(this);
        myAlert.setMessage("You are Newbie in Level-3" + " & Scores : " + marks)
    ...
    public void pupil(int marks){
        AlertDialog.Builder myAlert = new AlertDialog.Builder(this);
        myAlert.setMessage("You are Pupil in Level-3" + " & Scores : " + marks)
                .setPositiveButton("Exit", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialogInterface, int i) {
                        dialogInterface.dismiss();
    ...
    public void specialist(int marks){
        AlertDialog.Builder myAlert = new AlertDialog.Builder(this);
        myAlert.setMessage("You are Specialist in Level-3" + " & Scores : " + marks)
                .setPositiveButton("Exit", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialogInterface, int i) {
                        dialogInterface.dismiss();
    ...
    public void expert(int marks){
        AlertDialog.Builder myAlert = new AlertDialog.Builder(this);
        myAlert.setMessage("You are Expert in Level-3" + " & Scores : " + marks)
                .setPositiveButton("Exit", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialogInterface, int i) {
                        dialogInterface.dismiss();
    ...
    public void master(int marks){
        AlertDialog.Builder myAlert = new AlertDialog.Builder(this);
        myAlert.setMessage("You are Master in Level-3" + " & Scores : " + marks)
                .setPositiveButton("Exit", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialogInterface, int i) {
                        dialogInterface.dismiss();
    ...
    public void grandmaster(int marks){
        AlertDialog.Builder myAlert = new AlertDialog.Builder(this);
        myAlert.setMessage("You are Grandmaster in Level-3" + " & Scores : " + marks)
                .setPositiveButton("Exit", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialogInterface, int i) {
                        dialogInterface.dismiss();
